...
TRAIN_DATA_DIR='/home/work/dacon/train_gt'
VALID_DATA_DIR=f'/home/work/dacon/valid_input/{SEED=}-{MIN_POLYGON_BBOX_SIZE=}'
TEST_DATA_DIR='/home/work/dacon/test_input'
SUBMISSON_DATA_DIR='./submission8'
EXPERIMENT_NAME='baseline'

L.seed_everything(SEED)

train_df = pd.read_csv('/home/work/dacon/train_preproc.csv')
test_df = pd.read_csv('/home/work/dacon/test_preproc.csv')
...
checkpoint_callback = ModelCheckpoint(
    ...
    mode='max',
    dirpath='./checkpoint',
    filename='best_model',  # 고정된 파일 이름 사용
    save_top_k=1,
...
trainer = L.Trainer(max_epochs=50, precision='bf16-mixed', callbacks=[checkpoint_callback, earlystopping_callback], detect_anomaly=False)

trainer.fit(lit_ir_model, train_dataloader, valid_dataloader)

# 고정된 파일 이름으로 체크포인트 로드
...
if os.path.exists(submission_file):
    print(f"ZIP 파일이 생성되었습니다: {submission_file}")
else:
    print("ZIP 파일을 찾을 수 없습니다. 경로를 확인하세요.")