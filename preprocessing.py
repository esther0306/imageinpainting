...
Original file is located at
    https://colab.research.google.com/drive/1KMSdT9JtzQUK55rAPpGMEAzATLaNuj9o
"""
...
# dataset.zip 압축 풀기
!unzip --qq /content/drive/MyDrive/open3.zip -d dataset
...
image_paths = sorted(glob('/content/dataset/train_gt/TRAIN_*.png'))
...
test_image_paths = sorted(glob('/content/dataset/test_input/TEST_*.png'))
